...
form.addEventListener("submit", function (e) {
  ...
  _axios.default.post("https://todoo.5xcamp.us/users/", userData).then(function (data) {
    console.log(data);
  });
});
loginForm.addEventListener("submit", function (e) {
  ...
  _axios.default.post("https://todoo.5xcamp.us/users/sign_in", userData).then(function (data) {
    var div = document.querySelector(".token");
    div.insertAdjacentHTML("beforeend", "<p>".concat(data.headers.authorization, "</p>"));
...
checkButton.addEventListener("click", function (e) {
  var token = localStorage.getItem("todo-token");

  _axios.default.get("https://todoo.5xcamp.us/check", {
    headers: {
      authorization: token
    }
  }).then(function (_ref) {
...
document.querySelector("#logout_form").addEventListener("submit", function (e) {
  e.preventDefault();
  var token = localStorage.getItem("todo-token");

  _axios.default.delete("https://todoo.5xcamp.us/users/sign_out", {
    headers: {
      authorization: token
    }
  }).then(function (_ref2) {
    var data = _ref2.data;
    var logOutStatus = document.querySelector("#logOutStatus");
...
addForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var token = localStorage.getItem("todo-token");
  var todo = document.querySelector("#todoContent");
  var todoData = {
    todo: {
  ...
  _axios.default.post("https://todoo.5xcamp.us/todos", todoData, {
    headers: {
      authorization: token
    }
  }).then(function (_ref3) {
    ...
    todolist.insertAdjacentHTML = ("afterbegin", "<ul>".concat(data.content, "</ul>"));
  });

  if (token) {
    _axios.default.get("https://todoo.5xcamp.us/todos", {
      headers: {
        Authorization: token
      }
    }).then(function (_ref4) {
